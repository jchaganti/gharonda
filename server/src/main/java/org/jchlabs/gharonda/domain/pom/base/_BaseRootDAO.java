...
public abstract class _BaseRootDAO {
	...
	public static void initialize() {
		org.jchlabs.gharonda.domain.pom.dao._RootDAO.initialize((String) null);
	}
	...
	public static void initialize(String configFileName) {
		org.jchlabs.gharonda.domain.pom.dao._RootDAO.initialize(configFileName,
				org.jchlabs.gharonda.domain.pom.dao._RootDAO.getNewConfiguration(null));
	}
	...
	public static void initialize(String configFileName, Configuration configuration) {
		if (null != sessionFactoryMap && null != sessionFactoryMap.get(configFileName))
			...
			if (null == configFileName) {
				...
				org.jchlabs.gharonda.domain.pom.dao._RootDAO.setSessionFactory(null, configuration.buildSessionFactory());
			} else {
				configuration.configure(configFileName);
				org.jchlabs.gharonda.domain.pom.dao._RootDAO.setSessionFactory(configFileName,
	...
	public SessionFactory getSessionFactory(String configFileName) {
		...
		if (null == sf)
			throw new RuntimeException("The session factory for '" + configFileName
	...
	/**
	 * Return a new Configuration to use. This is not a mistake and is meant to be overridden in the RootDAO if you want
	 * to do something different. The file name is passed in so you have that to access. The config file is read in the
	 * initialize method.
	 */
